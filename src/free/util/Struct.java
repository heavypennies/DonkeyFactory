 ...
 * of (constant) data. It's especially convenient for holding a large
...
public class Struct{
  ...
  protected void setIntegerProperty(String propertyName, int propertyValue){
  ...
  protected void setCharProperty(String propertyName, char propertyValue){
  ...
  protected Object getProperty(Object property){
  ...
  protected int getIntegerProperty(Object property){
  ...
  protected char getCharProperty(Object property){
  ...
  protected String getStringProperty(Object property){
  ...
  protected boolean getBooleanProperty(Object property){
