...
public class FontSelectorPanel extends JPanel{
  ...
  private JTextField fontNameField = new free.workarounds.FixedJTextField();
  ...
  private JTextField fontSizeField = new free.workarounds.FixedJTextField(new IntegerStrictPlainDocument(1, 72), "", 2);
  ...
  private JList fontSizesList = new JList(new String[]{"5", "6", "7", "8", "9",
  ...
  public static class DefaultPreviewPanel extends JLabel implements ChangeListener{
    ...
    protected FontSelectorPanel fontSelectorPanel;
