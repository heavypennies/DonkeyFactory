...
public class SoughtGraph extends JComponent{
  ...
  protected static int BULLET_SLOTS = 7;
  ...
  protected static int BLITZ_SLOTS = 28;
  ...
  protected static int STANDARD_SLOTS = 15;
  ...
  protected static int RATING_SLOTS = 32;
  ...
  protected static double GRAPH_WIDTH_PERCENTAGE = 15.0/16.0;
  ...
  protected static double GRAPH_HEIGHT_PERCENTAGE = 9.0/10.0;
  ...
  protected Hashtable seeksToLocations = new Hashtable();
  ...
  protected Seek [][] seekMatrix = new Seek[BULLET_SLOTS+BLITZ_SLOTS+STANDARD_SLOTS][RATING_SLOTS];
  ...
  private Hashtable [] seekImageCache;
