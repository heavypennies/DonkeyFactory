...
public class TextStyleChooserPanel extends JPanel{
  ...
  private FontSelectorPanel fontSelector;
  ...
  private ColorChooserButton foregroundChooser;
  ...
  private ColorChooserButton backgroundChooser;
  ...
  public TextStyleChooserPanel(Font initialFont, Color initForegroundColor, Color initBackgroundColor,
      boolean initAntialiasingValue, boolean allowBackgroundSelection, boolean allowAntialiasingSelection){
