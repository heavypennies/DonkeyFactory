...
public class ConsolePreferencesPanel extends PreferencesPanel{
  ...
  private Vector categoryPanels = new Vector();
  ...
  private JPanel categoryPanelHolder = new JPanel(new BorderLayout());
  ...
  protected ChangeListener settingsChangeListener = new ChangeListener(){
  ...
  protected static class CategoryPanel extends JPanel{
    ...
    private TextStyleChooserPanel textStyleChooser;
