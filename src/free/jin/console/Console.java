...
public class Console extends JPanel implements KeyListener, ContainerListener{
  ...
  private ConsoleTextPane outputComponent;
  ...
  private ConsoleTextField inputComponent;
  ...
  private static Pattern urlRegex = new Pattern("(((ftp|http(s)?)://)|(www\\.))([^\\s()<>\"])*[^\\s.,()<>\"!]");
  ...
  private static Pattern emailRegex = new Pattern("[^\\s()<>\"]+@[^\\s()<>\"]+\\.[^\\s.,()<>\"]+");
  ...
  private Hashtable attributesCache = new Hashtable();
  ...
  protected boolean prepareAdding(){
  ...
  protected void assureScrolling(boolean scrollToBottom){
