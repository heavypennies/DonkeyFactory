...
package free.jin.chessclub.scripter;
...
public class ChessclubScripter extends Scripter{
  ...
  private class ChatScriptDispatcher extends ScriptDispatcher implements ChatListener{
    ...
    private String [] subtypes = new String[]{"Personal Tell", "(Bughouse) Partner Tell", "QTell", "Shout", "Serious Shout", "Announcement", "Channel Tell", "Channel QTell", "Kibitz", "Whisper"};

    private Hashtable chatTypesToSubtypeNames = new Hashtable();
