...
public class JinChessclubConnection extends ChessclubConnection implements JinConnection, 
  ...
  private ChessclubJinListenerManager listenerManager = new ChessclubJinListenerManager(this);
...
//    nonStartedGames.clear();
  ...
  private Hashtable gameNumbersToGameInfo = new Hashtable(1);
  ...
  private Hashtable nonStartedGames = new Hashtable(1);
  ...
  private Hashtable chessEvents = new Hashtable();
