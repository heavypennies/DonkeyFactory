...
public class Player implements Cloneable{
  ...
  private /*transient*/ int timestampClientNumber;
  ...
  public int getRatingType(int ratingIndex){
  ...
  public int getTimestampClientNumber(){
  ...
  public void setRating(int ratingIndex, int newRating, int newRatingType){
  ...
  public void setState(int playerState, int gameNumber){
    this.playerState = playerState;
    this.gameNumber = gameNumber;
  }
