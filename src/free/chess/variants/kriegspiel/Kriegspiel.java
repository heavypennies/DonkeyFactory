...
public class Kriegspiel implements WildVariant{
  ...
  private static ChessPiece [] whitePromotionTargets = new ChessPiece[]{ChessPiece.WHITE_QUEEN,
  ...
  private static ChessPiece [] blackPromotionTargets = new ChessPiece[]{ChessPiece.BLACK_QUEEN,
