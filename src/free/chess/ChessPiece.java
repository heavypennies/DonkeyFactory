...
public class ChessPiece extends Piece{
  ...
  protected static int KING = 6;




  // objects representing each piece.

  public static ChessPiece WHITE_PAWN   = new ChessPiece(WHITE,PAWN);
  public static ChessPiece WHITE_KNIGHT = new ChessPiece(WHITE,KNIGHT);
  public static ChessPiece WHITE_BISHOP = new ChessPiece(WHITE,BISHOP);
  public static ChessPiece WHITE_ROOK   = new ChessPiece(WHITE,ROOK);
  public static ChessPiece WHITE_QUEEN  = new ChessPiece(WHITE,QUEEN);
  public static ChessPiece WHITE_KING   = new ChessPiece(WHITE,KING);
  
  public static ChessPiece BLACK_PAWN   = new ChessPiece(BLACK,PAWN);
  public static ChessPiece BLACK_KNIGHT = new ChessPiece(BLACK,KNIGHT);
  public static ChessPiece BLACK_BISHOP = new ChessPiece(BLACK,BISHOP);
  public static ChessPiece BLACK_ROOK   = new ChessPiece(BLACK,ROOK);
  public static ChessPiece BLACK_QUEEN  = new ChessPiece(BLACK,QUEEN);
  public static ChessPiece BLACK_KING   = new ChessPiece(BLACK,KING);
  ...
  public boolean isSameColorAs(ChessPiece otherPiece){
  ...
  public boolean isSameTypeAs(ChessPiece otherPiece){
